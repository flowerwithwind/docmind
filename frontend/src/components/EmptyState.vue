<template>
  <div class="empty">
    <div class="art"><el-icon :size="44"><component :is="icon" /></el-icon></div>
...
defineProps({ icon: { type: [Object, String], default: Document }, title: { type: String, default: '暂无数据' }, desc: { type: String, default: '' } })
</script>
<style scoped>
