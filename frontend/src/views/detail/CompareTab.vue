...
.history-item:hover { border-color: var(--dm-primary-light); background: var(--dm-fill); }
...
.sec-row { display: flex; align-items: center; gap: 14px; padding: 9px 8px; border-bottom: 1px solid var(--dm-fill-strong); }
